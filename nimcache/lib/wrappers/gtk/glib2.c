...
STRING_LITERAL(TMP124182, "libgobject-2.0-0.dll", 20);
STRING_LITERAL(TMP124183, "libgobject-2.0-0.dll", 20);
...
Dl_18717 = (TY18718) nimGetProcAddr(TMP124181, "g_signal_connect_data");
F.len = 0;
framePtr = framePtr->prev;
}
