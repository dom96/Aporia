...
STRING_LITERAL(TMP124076, "libgtk-win32-2.0-0.dll", 22);
STRING_LITERAL(TMP124077, "libgtk-win32-2.0-0.dll", 22);
static void* TMP124075;
TY52826 Dl_52825;
TY54462 Dl_54461;
TY56317 Dl_56316;
TY56243 Dl_56242;
...
F.line = 0;
framePtr = (TFrame*)&F;
if (!((TMP124075 = nimLoadLibrary((NimStringDesc*) &TMP124076))
)) nimLoadLibraryError((NimStringDesc*) &TMP124077);
Dl_52825 = (TY52826) nimGetProcAddr(TMP124075, "gtk_main_quit");
Dl_54461 = (TY54462) nimGetProcAddr(TMP124075, "gtk_statusbar_pop");
Dl_56316 = (TY56317) nimGetProcAddr(TMP124075, "gtk_text_buffer_get_iter_at_mark");
Dl_56242 = (TY56243) nimGetProcAddr(TMP124075, "gtk_text_buffer_get_insert");
Dl_54828 = (TY54829) nimGetProcAddr(TMP124075, "gtk_text_iter_get_line");
Dl_54831 = (TY54832) nimGetProcAddr(TMP124075, "gtk_text_iter_get_line_offset");
Dl_54456 = (TY54457) nimGetProcAddr(TMP124075, "gtk_statusbar_push");
Dl_53164 = (TY53165) nimGetProcAddr(TMP124075, "gtk_notebook_get_current_page");
Dl_53231 = (TY53232) nimGetProcAddr(TMP124075, "gtk_notebook_set_tab_label_text");
Dl_53170 = (TY53171) nimGetProcAddr(TMP124075, "gtk_notebook_get_nth_page");
Dl_53803 = (TY53804) nimGetProcAddr(TMP124075, "gtk_scrolled_window_new");
Dl_44994 = (TY44995) nimGetProcAddr(TMP124075, "gtk_widget_show");
Dl_45300 = (TY45301) nimGetProcAddr(TMP124075, "gtk_widget_modify_font");
Dl_53845 = (TY53846) nimGetProcAddr(TMP124075, "gtk_scrolled_window_add_with_viewport");
Dl_56738 = (TY56739) nimGetProcAddr(TMP124075, "gtk_text_view_get_buffer");
Dl_46346 = (TY46347) nimGetProcAddr(TMP124075, "gtk_label_new");
Dl_53125 = (TY53126) nimGetProcAddr(TMP124075, "gtk_notebook_append_page");
Dl_56734 = (TY56735) nimGetProcAddr(TMP124075, "gtk_text_view_set_buffer");
Dl_53178 = (TY53179) nimGetProcAddr(TMP124075, "gtk_notebook_set_current_page");
Dl_56135 = (TY56136) nimGetProcAddr(TMP124075, "gtk_text_buffer_set_text");
Dl_56303 = (TY56304) nimGetProcAddr(TMP124075, "gtk_text_buffer_get_start_iter");
Dl_56307 = (TY56308) nimGetProcAddr(TMP124075, "gtk_text_buffer_get_end_iter");
Dl_56188 = (TY56189) nimGetProcAddr(TMP124075, "gtk_text_buffer_get_text");
Dl_49911 = (TY49912) nimGetProcAddr(TMP124075, "gtk_entry_get_text");
Dl_56356 = (TY56357) nimGetProcAddr(TMP124075, "gtk_text_buffer_get_selection_bounds");
Dl_56233 = (TY56234) nimGetProcAddr(TMP124075, "gtk_text_buffer_move_mark_by_name");
Dl_49658 = (TY49659) nimGetProcAddr(TMP124075, "gtk_menu_new");
Dl_53715 = (TY53716) nimGetProcAddr(TMP124075, "gtk_radio_menu_item_new_with_label");
Dl_49533 = (TY49534) nimGetProcAddr(TMP124075, "gtk_menu_shell_append");
Dl_63283 = (TY63284) nimGetProcAddr(TMP124075, "gtk_signal_connect_full");
Dl_53723 = (TY53724) nimGetProcAddr(TMP124075, "gtk_radio_menu_item_get_group");
Dl_47899 = (TY47900) nimGetProcAddr(TMP124075, "gtk_check_menu_item_set_active");
Dl_49660 = (TY49661) nimGetProcAddr(TMP124075, "gtk_menu_popup");
Dl_52927 = (TY52928) nimGetProcAddr(TMP124075, "gtk_get_current_event_time");
Dl_45489 = (TY45490) nimGetProcAddr(TMP124075, "gtk_accel_group_new");
Dl_46007 = (TY46008) nimGetProcAddr(TMP124075, "gtk_window_add_accel_group");
Dl_52971 = (TY52972) nimGetProcAddr(TMP124075, "gtk_menu_bar_new");
Dl_47682 = (TY47683) nimGetProcAddr(TMP124075, "gtk_menu_item_new_with_label");
Dl_53982 = (TY53983) nimGetProcAddr(TMP124075, "gtk_separator_menu_item_new");
Dl_45046 = (TY45047) nimGetProcAddr(TMP124075, "gtk_widget_add_accelerator");
Dl_47685 = (TY47686) nimGetProcAddr(TMP124075, "gtk_menu_item_new_with_mnemonic");
Dl_47688 = (TY47689) nimGetProcAddr(TMP124075, "gtk_menu_item_set_submenu");
Dl_46915 = (TY46916) nimGetProcAddr(TMP124075, "gtk_box_pack_start");
Dl_57120 = (TY57121) nimGetProcAddr(TMP124075, "gtk_toolbar_new");
Dl_57230 = (TY57231) nimGetProcAddr(TMP124075, "gtk_toolbar_set_style");
Dl_57150 = (TY57151) nimGetProcAddr(TMP124075, "gtk_toolbar_insert_stock");
Dl_57159 = (TY57160) nimGetProcAddr(TMP124075, "gtk_toolbar_append_space");
Dl_53123 = (TY53124) nimGetProcAddr(TMP124075, "gtk_notebook_new");
Dl_53209 = (TY53210) nimGetProcAddr(TMP124075, "gtk_notebook_set_scrollable");
Dl_48617 = (TY48618) nimGetProcAddr(TMP124075, "gtk_hbox_new");
Dl_49863 = (TY49864) nimGetProcAddr(TMP124075, "gtk_entry_new");
Dl_45034 = (TY45035) nimGetProcAddr(TMP124075, "gtk_widget_size_request");
Dl_45176 = (TY45177) nimGetProcAddr(TMP124075, "gtk_widget_set_size_request");
Dl_47108 = (TY47109) nimGetProcAddr(TMP124075, "gtk_button_new_with_label");
Dl_47106 = (TY47107) nimGetProcAddr(TMP124075, "gtk_button_new");
Dl_51730 = (TY51731) nimGetProcAddr(TMP124075, "gtk_image_new_from_stock");
Dl_45640 = (TY45641) nimGetProcAddr(TMP124075, "gtk_container_add");
Dl_46922 = (TY46923) nimGetProcAddr(TMP124075, "gtk_box_pack_end");
Dl_54450 = (TY54451) nimGetProcAddr(TMP124075, "gtk_statusbar_new");
Dl_45985 = (TY45986) nimGetProcAddr(TMP124075, "gtk_window_new");
Dl_46198 = (TY46199) nimGetProcAddr(TMP124075, "gtk_window_set_default_size");
Dl_45988 = (TY45989) nimGetProcAddr(TMP124075, "gtk_window_set_title");
Dl_48491 = (TY48492) nimGetProcAddr(TMP124075, "gtk_vbox_new");
Dl_52819 = (TY52820) nimGetProcAddr(TMP124075, "gtk_init");
Dl_52817 = (TY52818) nimGetProcAddr(TMP124075, "gtk_main");
F.len = 0;
framePtr = framePtr->prev;
}
