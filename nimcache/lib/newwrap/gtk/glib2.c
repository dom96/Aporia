...
STRING_LITERAL(TMP124222, "libgobject-2.0-0.dll", 20);
STRING_LITERAL(TMP124223, "libgobject-2.0-0.dll", 20);
static void* TMP124221;
TY18718 Dl_18717;
...
F.line = 0;
framePtr = (TFrame*)&F;
if (!((TMP124221 = nimLoadLibrary((NimStringDesc*) &TMP124222))
)) nimLoadLibraryError((NimStringDesc*) &TMP124223);
Dl_18717 = (TY18718) nimGetProcAddr(TMP124221, "g_signal_connect_data");
F.len = 0;
framePtr = framePtr->prev;
}
