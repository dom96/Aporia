...
unsureAsgnRef((void**) &(*Result).Name, copyString(((NimStringDesc*) &TMP124172)));
unsureAsgnRef((void**) &(*Result).Ext, copyString(((NimStringDesc*) &TMP124172)));
goto LA2;
LA5: ;
Seppos_117139 = 0;
F.line = 456;
